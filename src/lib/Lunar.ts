...
export class Lunar {
    ...
    toFullString(): string {
        ...
        s += ' 敏感词[' + this.getXiu() + this.getZheng() + this.getAnimal() + '](' + this.getXiuLuck() + ')';
        s += ' 敏感词[' + this.getPengZuGan() + ' ' + this.getPengZuZhi() + ']';
        s += ' 敏感词[' + this.getDayPositionXi() + '](' + this.getDayPositionXiDesc() + ')';
        s += ' 敏感词[' + this.getDayPositionYangGui() + '](' + this.getDayPositionYangGuiDesc() + ')';
        s += ' 敏感词[' + this.getDayPositionYinGui() + '](' + this.getDayPositionYinGuiDesc() + ')';
        s += ' 敏感词[' + this.getDayPositionFu() + '](' + this.getDayPositionFuDesc() + ')';
        s += ' 敏感词[' + this.getDayPositionCai() + '](' + this.getDayPositionCaiDesc() + ')';
        s += ' 敏感词[' + this.getDayChongDesc() + ']';
        s += ' 敏感词[' + this.getDaySha() + ']';
        return s;
    }
