...
export class LunarYear {
    ...
    getTouLiang(): string {
        return this._getZaoByZhi(0, '敏感词');
    }
    ...
    getGengTian(): string {
        return this._getZaoByZhi(1, '敏感词');
    }

    getHuaShou(): string {
        return this._getZaoByZhi(3, '敏感词');
    }

    getZhiShui(): string {
        return this._getZaoByZhi(4, '敏感词');
    }

    getTuoGu(): string {
        return this._getZaoByZhi(6, '敏感词');
    }

    getQiangMi(): string {
        return this._getZaoByZhi(9, '敏感词');
    }
    ...
    getGongZhu(): string {
        return this._getZaoByZhi(11, '敏感词');
    }

    getJiaTian(): string {
        return this._getZaoByGan(0, '敏感词');
    }

    getFenBing(): string {
        return this._getZaoByGan(2, '敏感词');
    }

    getDeJin(): string {
        return this._getZaoByGan(7, '敏感词');
    }

    getRenBing(): string {
        return this._getZaoByGan(2, this._getZaoByZhi(2, '敏感词'));
    }

    getRenChu(): string {
        return this._getZaoByGan(3, this._getZaoByZhi(2, '敏感词'));
    }
